...
import type { UpdateIntegrationConfigCommand } from "@/modules/integrations/application/commands/UpdateIntegrationConfigCommand";
...
export class UpdateIntegrationConfigHandler {
  ...
  public async handle(command: UpdateIntegrationConfigCommand) {
