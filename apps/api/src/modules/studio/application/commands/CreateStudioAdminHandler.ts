...
import type { CreateStudioAdminCommand } from "@/modules/studio/application/commands/CreateStudioAdminCommand";
...
export class CreateStudioAdminHandler {
  ...
  public async handle(command: CreateStudioAdminCommand) {
