...
import type { UpdateSubscriptionCommand } from "@/modules/subscriptions/application/commands/UpdateSubscriptionCommand";
...
export class UpdateSubscriptionHandler {
  ...
  public async handle(command: UpdateSubscriptionCommand) {
