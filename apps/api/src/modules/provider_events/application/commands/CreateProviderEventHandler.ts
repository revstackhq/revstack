...
import type { CreateProviderEventCommand } from "@/modules/provider_events/application/commands/CreateProviderEventCommand";
...
export class CreateProviderEventHandler {
  ...
  public async handle(command: CreateProviderEventCommand) {
