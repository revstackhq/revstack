...
import type { GetProviderEventQuery } from "@/modules/provider_events/application/queries/GetProviderEventQuery";
...
export class GetProviderEventHandler {
  ...
  public async handle(query: GetProviderEventQuery) {
