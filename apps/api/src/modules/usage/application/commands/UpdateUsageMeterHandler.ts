...
import type { UpdateUsageMeterCommand } from "@/modules/usage/application/commands/UpdateUsageMeterCommand";
...
export class UpdateUsageMeterHandler {
  ...
  public async handle(command: UpdateUsageMeterCommand) {
