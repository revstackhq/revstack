...
import type { CreateUsageMeterCommand } from "@/modules/usage/application/commands/CreateUsageMeterCommand";
...
export class CreateUsageMeterHandler {
  ...
  public async handle(command: CreateUsageMeterCommand) {
