...
import type { DeletePlanEntitlementCommand } from "@/modules/plan_entitlements/application/commands/DeletePlanEntitlementCommand";
...
export class DeletePlanEntitlementHandler {
  ...
  public async handle(command: DeletePlanEntitlementCommand) {
