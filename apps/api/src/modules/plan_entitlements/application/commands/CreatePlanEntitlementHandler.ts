...
import type { CreatePlanEntitlementCommand } from "@/modules/plan_entitlements/application/commands/CreatePlanEntitlementCommand";
...
export class CreatePlanEntitlementHandler {
  ...
  public async handle(command: CreatePlanEntitlementCommand) {
