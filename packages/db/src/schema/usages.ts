 ...
 */
export const usages = revstack.table(
  "usages",
  {
    id: text("id")
  ...
  (t) => [
    index("usage_env_user_time_idx").on(t.environmentId, t.userId, t.timestamp),
    index("usage_entitlement_time_idx").on(t.entitlementId, t.timestamp),
  ],
);
 ...
 */
export const usageMeters = revstack.table(
  "usage_meters",
  {
    id: text("id")
  ...
  (t) => [
    uniqueIndex("usage_meter_unique_idx").on(
      t.environmentId,
      t.userId,
      t.entitlementId,
    ),
